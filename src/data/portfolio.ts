...
export const projectsDb: Record<string, ProjectEntity> = {
  // Flagship / ACE
  'ems': {
    id: 'ems',
  ...
  'evolver': {
    ...
    isAceProject: true,
    typeAce: 'Infrastructure • EMS Component',
    periodAce: '1 Month Engineering',
  ...
  'erp-modules': {
    ...
    isAceProject: true,
    typeAce: 'Business Logic • Full-Stack',
    periodAce: '2024 — 2025',
    modules: [
  ...
  'ace-vault': {
    ...
    approachAce: 'Designed multi-layered security: inner loops use C++ for raw cryptographic operations via OpenSSL wrappers; outer layers use .NET for secure memory management and PWA interface. Implemented zero-knowledge principles where applicable.',
    impact: [
    ...
    isFlagship: true,
    isAceProject: true,
    typeAce: 'Security • Cryptography',
    periodAce: '2023'
  },
  'external-partner-integrations': {
    id: 'external-partner-integrations',
    ...
    isAceProject: true,
    typeAce: 'Integrations • API',
    periodAce: '2023 — Present',
  ...
  'real-time-infrastructure': {
    ...
    isAceProject: true,
    typeAce: 'Infrastructure • SignalR',
    periodAce: '2024',
    impact: [
  ...
  'logging-framework': {
    ...
    isAceProject: true,
    typeAce: 'Infrastructure • Observability',
    periodAce: '2024 — Present',
    architecturalHighlights: [
  ...
  'schemaflow': {
    ...
    summary: 'Visual, interactive query canvases.',
  ...
  'schema-weaver': {
    ...
    summary: 'Auto-decluttered 3D database maps.',
  ...
  'letitgo': {
    ...
    summary: 'Minimalist elapsed time observer.',
  ...
  'githubify-md': {
    ...
    summary: 'TUI for MD-to-HTML conversion.',
  ...
  'moire-effect': {
    ...
    summary: 'Interactive optical interference demo.',
  ...
  'smart-cleanup': {
    ...
    summary: 'Configurable automated system maintenance.',
  ...
  'myportfolio': {
    ...
    summary: 'Living testament to Discipline of Restraint.',
  ...
  'myuniversity': {
    ...
    isOpenSource: true,
    roleOpenSource: 'Creator'
  }
};

export const experiencesDb: Record<string, ExperienceEntity> = {
  'ace': {
    id: 'ace',
...
export const vulnerabilityDiscoveries = [
  {
